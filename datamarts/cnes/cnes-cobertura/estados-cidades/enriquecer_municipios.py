...
def enriquecer_municipios():
    ...
    df_estados = df_estados.rename(columns={"uf": "UF", "nome": "ESTADO_NOME"})
    ...
    df_municipios = pd.merge(df_municipios,
                             df_municipios_com_regionais_saude[
                                 ['CODUFMUN', "UF", 'COD_REGIAO_SAUDE', 'NOME_REGIAO_SAUDE', 'ESTADO_NOME']],
                             on='CODUFMUN',
                             how='left')
    df_municipios = pd.merge(df_municipios,
                             ...
                             on="CODUFMUN",
                             how="left")
    # df_municipios['nome'] = df_municipios['nome'] + ', ' + df_municipios['ESTADO_NOME'] + ', Brasil'
